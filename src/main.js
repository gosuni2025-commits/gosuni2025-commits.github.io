...
const PAGE_TEXT = {
  ko: {
    ...
    'meta.index.description': 'Gosuni2025에서 만든 모바일 앱과 게임을 소개하는 공식 홈페이지입니다.',
    ...
    'home.hero.subtitle': '좀비를 막아내는 긴장감부터 쌀알을 손으로 분류하는 가벼운 손맛까지, 각 앱은 자기만의 페이지에서 따로 만날 수 있습니다.',
  ...
  ja: {
    ...
    'meta.index.description': 'Gosuni2025が制作したモバイルアプリとゲームを紹介する公式サイトです。',
    ...
    'home.hero.subtitle': 'ゾンビを防ぐ緊張感から米粒を手で仕分ける軽い手触りまで、それぞれのアプリを専用ページで紹介します。',
    'home.apps.kicker': 'Released Apps',
  ...
  'zh-CN': {
    ...
    'meta.index.description': 'Gosuni2025 制作的移动应用和游戏官方网站。',
    ...
    'home.hero.subtitle': '从抵挡僵尸的紧张感，到手动分类米粒的轻快手感，每款应用都有自己的专属页面。',
    'home.apps.kicker': 'Released Apps',
  ...
  'zh-TW': {
    ...
    'meta.index.description': 'Gosuni2025 製作的行動應用程式與遊戲官方網站。',
    ...
    'home.hero.subtitle': '從抵擋殭屍的緊張感，到手動分類米粒的輕快手感，每款應用都有自己的專屬頁面。',
    'home.apps.kicker': 'Released Apps',
  ...
  en: {
    ...
    'meta.index.description': 'The official home for mobile apps and games made by Gosuni2025.',
    ...
    'home.hero.subtitle': 'From the pressure of holding back zombies to the light touch of sorting rice by hand, each app now has its own page.',
    'home.apps.kicker': 'Released Apps',
  ...
  es: {
    ...
    'meta.index.description': 'Sitio oficial de las apps y juegos móviles creados por Gosuni2025.',
    ...
    'home.hero.subtitle': 'Desde contener zombis hasta clasificar arroz a mano, cada app ahora tiene su propia página.',
    'home.apps.kicker': 'Released Apps',
