...
const TEXT = {
  ko: {
    ...
    'index.manual.status': 'iOS에서 이용 가능',
    'index.manual.description': '원을 키워 쌀알을 집고, 색깔별 목표 영역으로 옮기는 손맛 중심 물리 퍼즐입니다.',
    'index.manual.platform': 'iPhone용 무료 캐주얼 퍼즐',
  ...
  ja: {
    ...
    'index.manual.status': 'iOSで利用可能',
    'index.manual.description': '円を広げて米粒をつかみ、色ごとのゴールへ運ぶ手触り重視の物理パズルです。',
    'index.manual.platform': 'iPhone向け無料カジュアルパズル',
  ...
  'zh-CN': {
    ...
    'index.manual.status': 'iOS 可用',
    'index.manual.description': '放大圆圈抓取米粒，并把它们移动到对应颜色目标区的物理休闲益智游戏。',
    'index.manual.platform': 'iPhone 免费休闲益智游戏',
  ...
  'zh-TW': {
    ...
    'index.manual.platform': 'iPhone 免費休閒益智遊戲',
  ...
  en: {
    ...
    'index.manual.status': 'Available on iOS',
    ...
    'index.manual.platform': 'Free casual puzzle for iPhone',
  ...
  es: {
    ...
    'index.manual.status': 'Disponible en iOS',
    ...
    'index.manual.platform': 'Rompecabezas casual gratis para iPhone',
...
const PAGE_TEXT = {
  ko: {
    'meta.index.title': 'Gosuni2025 - 앱과 게임',
    'meta.index.description': '대국전열: 오토 배틀러, Zombie Defense, Manual Rice Sorting을 소개하는 Gosuni2025 공식 홈페이지입니다.',
    ...
    'meta.manual.description': '원을 키워 쌀알을 집고 색깔별 목표 영역으로 옮기는 iPhone용 물리 기반 캐주얼 퍼즐 Manual Rice Sorting 공식 페이지입니다.',
    ...
    'home.hero.subtitle': '전열을 짜는 오토 배틀러부터 좀비 디펜스, 쌀알 분류 퍼즐까지, 각 앱은 자기만의 페이지에서 따로 만날 수 있습니다.',
    'home.apps.kicker': 'Released Apps',
    'home.apps.title': '앱별로 나누어 보기',
    'home.apps.intro': '각 게임의 소개, 스토어 링크, 지원 정보를 전용 페이지에서 확인하세요.',
  ...
  ja: {
    'meta.index.title': 'Gosuni2025 - アプリとゲーム',
    'meta.index.description': 'Taikyoku Battleline: Auto Battler、Zombie Defense、Manual Rice Sortingを紹介するGosuni2025公式サイトです。',
    ...
    'meta.manual.description': '円を広げて米粒をつかみ、色ごとのゴールへ運ぶiPhone向け物理カジュアルパズル Manual Rice Sorting の公式ページです。',
    ...
    'home.hero.subtitle': '戦列を組むオートバトラーからゾンビ防衛、米粒仕分けパズルまで、それぞれのアプリを専用ページで紹介します。',
    'home.apps.kicker': 'Released Apps',
    'home.apps.title': 'アプリ別に見る',
    'home.apps.intro': '各ゲームの紹介、ストアリンク、サポート情報を専用ページで確認できます。',
  ...
  'zh-CN': {
    'meta.index.title': 'Gosuni2025 - 应用与游戏',
    'meta.index.description': 'Gosuni2025 官方网站，介绍 Taikyoku Battleline: Auto Battler、Zombie Defense 和 Manual Rice Sorting。',
    ...
    'meta.manual.description': 'Manual Rice Sorting 是一款 iPhone 物理休闲益智游戏，放大圆圈抓取米粒，并移动到对应颜色目标区。',
    ...
    'home.hero.subtitle': '从编排战线的自动战斗，到僵尸防守和米粒分类益智游戏，每款应用都有自己的专属页面。',
    'home.apps.kicker': 'Released Apps',
    'home.apps.title': '按应用查看',
    'home.apps.intro': '在专属页面查看每款游戏的介绍、商店链接和支持信息。',
  ...
  'zh-TW': {
    'meta.index.title': 'Gosuni2025 - 應用程式與遊戲',
    'meta.index.description': 'Gosuni2025 官方網站，介紹 Taikyoku Battleline: Auto Battler、Zombie Defense 與 Manual Rice Sorting。',
    ...
    'meta.manual.description': 'Manual Rice Sorting 是 iPhone 物理休閒益智遊戲，放大圓圈抓取米粒，並移動到對應顏色目標區。',
    ...
    'home.hero.subtitle': '從編排戰線的自動戰鬥，到殭屍防守和米粒分類益智遊戲，每款應用都有自己的專屬頁面。',
    'home.apps.kicker': 'Released Apps',
    'home.apps.title': '依應用查看',
    'home.apps.intro': '在專屬頁面查看每款遊戲的介紹、商店連結與支援資訊。',
  ...
  en: {
    'meta.index.title': 'Gosuni2025 - Apps & Games',
    'meta.index.description': 'The official Gosuni2025 home for Taikyoku Battleline: Auto Battler, Zombie Defense, and Manual Rice Sorting.',
    ...
    'meta.manual.description': 'Official page for Manual Rice Sorting, an iPhone physics casual puzzle where you grow a circle, pick up rice grains, and sort them by color.',
    ...
    'home.hero.subtitle': 'From formation-building auto battles to zombie defense and a rice sorting puzzle, each app has its own dedicated page.',
    'home.apps.kicker': 'Released Apps',
    'home.apps.title': 'Browse by App',
    'home.apps.intro': 'Find each game’s overview, store links, and support details on its dedicated page.',
  ...
  es: {
    'meta.index.title': 'Gosuni2025 - Apps y juegos',
    'meta.index.description': 'Sitio oficial de Gosuni2025 para Taikyoku Battleline: Auto Battler, Zombie Defense y Manual Rice Sorting.',
    ...
    'meta.manual.description': 'Página oficial de Manual Rice Sorting, un puzzle casual físico para iPhone donde agrandas un círculo, recoges granos de arroz y los ordenas por color.',
    ...
    'home.hero.subtitle': 'Desde auto batallas de formación hasta defensa zombi y un puzzle de arroz, cada app tiene su propia página.',
    'home.apps.kicker': 'Released Apps',
    'home.apps.title': 'Ver por app',
    'home.apps.intro': 'Consulta la descripción, enlaces de tienda y soporte de cada juego en su página dedicada.',
    ...
    'manual.nav.video': 'Video',
    'manual.hero.kicker': 'Disponible en iOS',
